...
<div class="faq">
	<div class="action-block faq__filter">
		<form action="" class="action-block__body form-inline">
			...
			<a href="#" class="btn btn-primary">Показать</a>
		</form>
	</div>
	<div class="faq__list">
		<div class="faq__item">
			...
			<div class="faq__item-preview-text">
				<p>Здравствуйте! Возможно ли выдача в мфц справки с места жительства? Или это возможно только в паспортных столах? <a href="#" class="readmore">Подробнее</a></p>
			</div>
		</div>
		<div class="faq__item">
			<div class="faq__item-date">02.11.2016</div>
			<div class="faq__item-preview-text">
				<p>Возможно ли отчуждение доли квартиры постороннему лицу без участия нотариуса? <a href="#" class="readmore">Подробнее</a></p>
			</div>
		</div>
		<div class="faq__item">
			<div class="faq__item-date">02.11.2016</div>
			<div class="faq__item-preview-text">
				<p>Я студентка одного из вузов Саратова, проживаю в общежитии, где имею временную прописку. Постоянно зарегистрирована НЕ в Саратовской области. Моим ежемесячным доходом является только стипендия, она разумеется ниже прожиточного минимума. Могу ли я получить <a href="#" class="readmore">Подробнее</a></p>
			</div>
		</div>
		<div class="faq__item">
			<div class="faq__item-date">02.11.2016</div>
